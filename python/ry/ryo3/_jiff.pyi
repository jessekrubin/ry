...
_T_Diff = t.TypeVar("_T_Diff", bound=Time | DateTime | ZonedDateTime | Date | Timestamp)

class DifferenceAbc(t.Generic[_T_Diff]):
    def __init__(
        self,
        obj: _T_Diff,
        *,
...
class TimeDifference(DifferenceAbc[Time]): ...
class DateTimeDifference(DifferenceAbc[DateTime]): ...
class ZonedDateTimeDifference(DifferenceAbc[ZonedDateTime]): ...
class DateDifference(DifferenceAbc[Date]): ...
class TimestampDifference(DifferenceAbc[Timestamp]): ...
