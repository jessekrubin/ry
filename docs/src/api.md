...
class DateTime:
  ...
  def saturating_add(self, other: TimeSpan | SignedDuration | Duration) -> DateTime: ...
  @t.overload
  ...
  @t.overload
  def saturating_sub(self, other: TimeSpan | SignedDuration | Duration) -> DateTime: ...
  def intz(self, tz: str) -> ZonedDateTime: ...
  def date(self) -> Date: ...
  def time(self) -> Time: ...
  @property
...
class TimeSpan:
  ...
  @classmethod
  def parse(cls: type[t.Self], s: str) -> t.Self: ...
  def with_years(self, years: int) -> t.Self: ...
  def with_months(self, months: int) -> t.Self: ...
  def with_weeks(self, weeks: int) -> t.Self: ...
  def with_days(self, days: int) -> t.Self: ...
  def with_hours(self, hours: int) -> t.Self: ...
  def with_minutes(self, minutes: int) -> t.Self: ...
  def with_seconds(self, seconds: int) -> t.Self: ...
  def with_milliseconds(self, milliseconds: int) -> t.Self: ...
  def with_microseconds(self, microseconds: int) -> t.Self: ...
  def with_nanoseconds(self, nanoseconds: int) -> t.Self: ...
  def replace(
    self,
    years: int | None = None,
...
class ZonedDateTime:
  ...
  def checked_add(self, other: TimeSpan | SignedDuration | Duration) -> t.Self: ...
  def saturating_add(self, other: TimeSpan | SignedDuration | Duration) -> t.Self: ...
  @t.overload
  def checked_sub(self, other: ZonedDateTime) -> TimeSpan: ...
  @t.overload
  def checked_sub(self, other: TimeSpan | SignedDuration | Duration) -> t.Self: ...
  @t.overload
  def saturating_sub(self, other: ZonedDateTime) -> TimeSpan: ...
  @t.overload
  def saturating_sub(self, other: TimeSpan | SignedDuration | Duration) -> t.Self: ...
  def round(self, options: JIFF_UNIT_STRING | DateTimeRound) -> t.Self: ...
  @property
  def year(self) -> int: ...
  @property
...
class Offset:
  ...
  def __init__(self, hours: int | None = None, seconds: int | None = None) -> None: ...
  def __str__(self) -> str: ...
  def __repr__(self) -> str: ...
  @classmethod
  ...
  def checked_add(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def checked_sub(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def constant(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def duration_since(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def duration_until(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def is_negative(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def negate(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def saturating_add(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def saturating_sub(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def seconds(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def since(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def to_datetime(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def to_time_zone(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def to_timestamp(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
  def until(self, *args: t.Any, **kwargs: t.Any) -> t.Any: ...
