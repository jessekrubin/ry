...
from ry._types import Buffer, Self, ToPy
from ry.ryo3._bytes import Bytes
...
class FsPath(ToPy[Path]):
    ...
    @property
    def parents(self) -> t.Sequence[Self]: ...
    @property
    ...
    # =========================================================================
    def ancestors(self) -> t.Iterator[Self]: ...
    def canonicalize(self) -> Self: ...
    def components(self) -> t.Iterator[Self]: ...
    def display(self) -> str: ...
    def ends_with(self, path: PathLike[str] | str) -> bool: ...
    def extension(self) -> str: ...
    def file_name(self) -> str: ...
    def file_prefix(self) -> Self: ...
    ...
    def strip_prefix(self, prefix: PathLike[str] | str) -> Self: ...
    def with_extension(self, ext: str) -> Self: ...
    def with_file_name(self, name: str) -> Self: ...

    # =========================================================================
    # FEATURE: `same-file`
    # =========================================================================
    def samefile(self, other: PathLike[str] | str | Self) -> bool: ...
    ...
    # DUNDERS
    # =========================================================================
    def __truediv__(self, other: PathLike[str] | str) -> Self: ...
    def __rtruediv__(self, other: PathLike[str] | str) -> Self: ...
...
class Headers:
    ...
    def __init__(
        self,
        headers: Mapping[_HeaderName, _VT] | Self | None = None,
        /,
        **kwargs: _VT,
    ) -> None: ...
    ...
    def __or__(self, other: Self | dict[str, str]) -> Self: ...
    def __ror__(self, other: Self | dict[str, str]) -> Self: ...
    ...
    def update(self, headers: Self | dict[str, str]) -> None: ...
...
class Date(ToPy[pydt.date], ToPyDate):
    ...
    @classmethod
    def from_pydate(cls, date: pydt.date) -> Self: ...
    ...
    # =========================================================================
    @classmethod
    def from_iso_week_date(cls, year: int, week: int, weekday: int) -> Self: ...
    @classmethod
    def today(cls) -> Self: ...
    @classmethod
    ...
    def duration_since(self, other: Self) -> SignedDuration: ...
    def duration_until(self, other: Self) -> SignedDuration: ...
    def era_year(self) -> tuple[int, t.Literal["BCE", "CE"]]: ...
    def first_of_month(self) -> Self: ...
    def first_of_year(self) -> Self: ...
    ...
    def last_of_month(self) -> Self: ...
    def last_of_year(self) -> Self: ...
    def nth_weekday(self, nth: int, weekday: Weekday) -> Self: ...
    def nth_weekday_of_month(self, nth: int, weekday: Weekday) -> Self: ...
    def replace(
        self,
        year: int | None = None,
        month: int | None = None,
    ...
    def series(self, span: TimeSpan) -> JiffSeries[Self]: ...
...
class Time(ToPy[pydt.time], ToPyTime, FromStr):
    ...
    @classmethod
    def from_pytime(cls, t: pydt.time) -> Self: ...

    # =========================================================================
    # CLASS METHODS
    # =========================================================================
    @classmethod
    def midnight(cls) -> Self: ...
    @classmethod
    def now(cls) -> Self: ...
    @classmethod
    def utcnow(cls) -> Self: ...
    ...
    def _round(self, options: TimeRound) -> Self: ...
    def series(self, span: TimeSpan) -> JiffSeries[Self]: ...
...
class DateTime(ToPy[pydt.datetime], ToPyDate, ToPyTime, ToPyDateTime, FromStr):
    ...
    # =========================================================================
    @classmethod
    def from_pydatetime(cls, dt: pydt.datetime) -> Self: ...
    ...
    def today(cls) -> Self: ...
    @classmethod
    def from_parts(cls, date: Date, time: Time) -> Self: ...
    ...
    @t.overload
    def __sub__(self, other: Self) -> TimeSpan: ...
    @t.overload
    def __sub__(
        self, other: TimeSpan | SignedDuration | Duration | pydt.timedelta
    ) -> Self: ...
    ...
    @t.overload
    def sub(self, other: Self) -> TimeSpan: ...
    @t.overload
    def sub(
        self, other: TimeSpan | SignedDuration | Duration | pydt.timedelta
    ) -> Self: ...
    @t.overload
    def saturating_sub(self, other: Self) -> TimeSpan: ...
    @t.overload
    def saturating_sub(
        self, other: TimeSpan | SignedDuration | Duration | pydt.timedelta
    ) -> Self: ...
    ...
    def _round(self, options: DateTimeRound) -> Self: ...
    def saturating_add(
        self, other: TimeSpan | SignedDuration | Duration | pydt.timedelta
    ) -> Self: ...
    def series(self, span: TimeSpan) -> JiffSeries[Self]: ...
...
class TimeZone(ToPy[pydt.tzinfo], ToPyTzInfo, FromStr):
    ...
    @classmethod
    def from_str(cls, s: TimezoneName) -> Self: ...
    @classmethod
    def from_pytzinfo(cls, tz: pydt.tzinfo) -> Self: ...
    ...
    # =========================================================================
    @classmethod
    def fixed(cls, offset: Offset) -> Self: ...
    @classmethod
    def get(cls, name: TimezoneName) -> Self: ...
    @classmethod
    def posix(cls, name: TimezoneName) -> Self: ...
    @classmethod
    def system(cls) -> Self: ...
    @classmethod
    def try_system(cls) -> Self: ...
    @classmethod
    def tzif(cls, name: str, data: bytes) -> Self: ...
    @classmethod
    def utc(cls) -> Self: ...
...
class SignedDuration(ToPy[pydt.timedelta], ToPyTimeDelta, FromStr):
    ...
    def __richcmp__(self, other: Self | pydt.timedelta, op: int) -> bool: ...
    ...
    # =========================================================================
    @classmethod
    def from_pytimedelta(cls, td: pydt.timedelta) -> Self: ...
    ...
    def parse(cls, s: str) -> Self: ...
    @classmethod
    def from_hours(cls, n: int) -> Self: ...
    @classmethod
    def from_micros(cls, n: int) -> Self: ...
    @classmethod
    def from_millis(cls, n: int) -> Self: ...
    @classmethod
    def from_mins(cls, n: int) -> Self: ...
    @classmethod
    def from_nanos(cls, n: int) -> Self: ...
    @classmethod
    def from_secs(cls, n: int) -> Self: ...
    @classmethod
    def from_secs_f32(cls, n: float) -> Self: ...
    @classmethod
    def from_secs_f64(cls, n: float) -> Self: ...
    ...
    def checked_add(self, other: Self) -> Self | None: ...
    def checked_div(self, other: int) -> Self | None: ...
    def checked_mul(self, other: int) -> Self | None: ...
    def checked_neg(self) -> Self | None: ...
    def checked_sub(self, other: Self) -> Self | None: ...
    def div_duration_f32(self, other: Self) -> float: ...
    def div_duration_f64(self, other: Self) -> float: ...
    def div_f32(self, other: int) -> float: ...
    def div_f64(self, other: int) -> float: ...
    def is_positive(self) -> bool: ...
    def mul_f32(self, other: int) -> Self: ...
    def mul_f64(self, other: int) -> Self: ...
    def saturating_add(self, other: Self) -> Self: ...
    def saturating_mul(self, other: int) -> Self: ...
    ...
    def _round(self, options: SignedDurationRound) -> Self: ...
...
class Timestamp(ToPy[pydt.datetime], ToPyDate, ToPyTime, ToPyDateTime, FromStr):
    ...
    def parse(cls, s: str) -> Self: ...
    @classmethod
    def from_millisecond(cls, millisecond: int) -> Self: ...
    @classmethod
    def from_microsecond(cls, microsecond: int) -> Self: ...
    @classmethod
    def from_nanosecond(cls, nanosecond: int) -> Self: ...
    @classmethod
    def from_second(cls, second: int) -> Self: ...
    ...
    def _round(self, options: TimestampRound) -> Self: ...
...
class ZonedDateTime(
    ...
    # =========================================================================
    @classmethod
    def now(cls, tz: TimezoneName | None = None) -> Self: ...
    @classmethod
    def utcnow(cls) -> Self: ...
    @classmethod
    def from_str(cls, s: str) -> Self: ...
    ...
    def parse(cls, s: str) -> Self: ...
    @classmethod
    def from_rfc2822(cls, s: str) -> Self: ...
    @classmethod
    def parse_rfc2822(cls, s: str) -> Self: ...
    @classmethod
    def from_parts(cls, timestamp: Timestamp, time_zone: TimeZone) -> Self: ...
    ...
    # INSTANCE METHODS
    # =========================================================================
    def astimezone(self, tz: str) -> Self: ...
    def date(self) -> Date: ...
    def datetime(self) -> DateTime: ...
    def iso_week_date(self) -> ISOWeekDate: ...
    def day_of_year(self) -> int: ...
    ...
    def _round(self, options: ZonedDateTimeRound) -> Self: ...
    def start_of_day(self) -> Self: ...
    def time(self) -> Time: ...
    def timestamp(self) -> Timestamp: ...
    def tomorrow(self) -> Self: ...
    def with_time_zone(self, tz: TimeZone) -> Self: ...
    def yesterday(self) -> Self: ...
...
class Offset(ToPy[pydt.tzinfo], ToPyTzInfo, FromStr):
    ...
    def utc(cls) -> Self: ...
    @classmethod
    def from_hours(cls, hours: int) -> Self: ...
    @classmethod
    ...
    def negate(self) -> Self: ...
    def since(self, other: Self) -> TimeSpan: ...
    def until(self, other: Self) -> TimeSpan: ...
    def round(
        self,
    ...
    def _round(self, options: OffsetRound) -> Self: ...
...
class TimeZoneDatabase:
    ...
    @classmethod
    def from_concatenated_path(cls, path: str) -> Self: ...
    @classmethod
...
class Duration(ToPy[pydt.timedelta], ToPyTimeDelta):
    ...
    def __int__(self) -> int: ...
    @t.overload
    def __truediv__(self, other: Self | pydt.timedelta) -> float: ...
    @t.overload
    def __truediv__(self, other: float) -> Self: ...
    @t.overload
    def __rtruediv__(self, other: Self | pydt.timedelta) -> float: ...
    @t.overload
    def __rtruediv__(self, other: float) -> Self: ...
    def __mul__(self, other: float) -> Self: ...
    def abs_diff(self, other: Self) -> Self: ...
    def sleep(self) -> None: ...
    ...
    @classmethod
    def from_millis(cls, millis: int) -> Self: ...
    @classmethod
    def from_mins(cls, mins: int) -> Self: ...
    @classmethod
    def from_nanos(cls, nanos: int) -> Self: ...
    @classmethod
    def from_secs(cls, secs: int) -> Self: ...
    @classmethod
    def from_secs_f32(cls, secs: float) -> Self: ...
    @classmethod
    def from_secs_f64(cls, secs: float) -> Self: ...
    @classmethod
    def from_days(cls, days: int) -> Self: ...
    @classmethod
    def from_weeks(cls, weeks: int) -> Self: ...
    def as_micros(self) -> int: ...
    def as_millis(self) -> int: ...
    def as_nanos(self) -> int: ...
    def as_secs(self) -> int: ...
    ...
    # =========================================================================
    def checked_add(self, other: Self) -> Self | None: ...
    def checked_div(self, other: Self) -> Self | None: ...
    def checked_mul(self, other: Self) -> Self | None: ...
    def checked_sub(self, other: Self) -> Self | None: ...
    def div_duration_f32(self, other: Self) -> float: ...
    def div_duration_f64(self, other: Self) -> float: ...
    def div_f32(self, other: float) -> Self: ...
    def div_f64(self, other: float) -> Self: ...
    def mul_f32(self, other: float) -> Self: ...
    def mul_f64(self, other: float) -> Self: ...
    def saturating_add(self, other: Self) -> Self: ...
    def saturating_mul(self, other: Self) -> Self: ...
    def saturating_sub(self, other: Self) -> Self: ...
...
class Instant:
    ...
    # INSTANCE METHODS
    # =========================================================================
    def checked_add(self, other: Duration) -> Self | None: ...
    def checked_duration_since(self, earlier: Self) -> Duration | None: ...
    def checked_sub(self, other: Duration) -> Self | None: ...
    def duration_since(self, earlier: Self) -> Duration: ...
    def elapsed(self) -> Duration: ...
    def saturating_duration_since(self, earlier: Self) -> Duration: ...
