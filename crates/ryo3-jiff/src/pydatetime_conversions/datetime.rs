...
//
// pub struct JiffTime(jiff::civil::Time);
// pub struct JiffDate(jiff::civil::Date);
// pub struct JiffDateTime(jiff::civil::DateTime);
// #[cfg(not(Py_LIMITED_API))]
// fn py_date_to_naive_date(py_date: &impl PyDateAccess) -> PyResult<JiffDate> {
//     date_from_pyobject(py_date).map(|d| JiffDate(d))
// }
//
// #[cfg(Py_LIMITED_API)]
