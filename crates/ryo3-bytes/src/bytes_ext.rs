    ...
    (
        ...
        impl $name $(<$($lt),*>)? {
            ...
            fn decode<'py>(
                ...
                let s = ::pyo3::types::PyString::from_object(&py_any, encoding, errors)?;
            ...
            /// ```
            #[classmethod]
            fn fromhex(_cls: &Bound<'_, ::pyo3::types::PyType>, s: &str) -> PyResult<Self> {
...
//     encoding: &str,
//     errors: &str,
// ) -> PyResult<Bound<'_, String>> {
//     let py_any = slf.into_bound_py_any(py)?;
//     pyo3::PyString::from_object(&py_any, encoding, errors)
// }
