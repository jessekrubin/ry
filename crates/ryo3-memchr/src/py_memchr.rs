...
#[must_use]
#[pyfunction]
pub fn memchr(needle: Byte, haystack: ReadableBuffer) -> Option<usize> {
...
#[must_use]
#[pyfunction]
pub fn memchr2(needle1: Byte, needle2: Byte, haystack: ReadableBuffer) -> Option<usize> {
...
#[must_use]
#[pyfunction]
pub fn memrchr(needle: Byte, haystack: ReadableBuffer) -> Option<usize> {
...
#[must_use]
#[pyfunction]
pub fn memrchr2(needle1: Byte, needle2: Byte, haystack: ReadableBuffer) -> Option<usize> {
