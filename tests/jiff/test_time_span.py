...
class TestSpanAdd:
    ...
    def test_add_rejects_positional_and_keyword_units(self) -> None:
        ...
        with pytest.raises(
            ...
            span.add(other, hours=2)  # type: ignore[call-overload]  # ty: ignore[invalid-argument-type]
    ...
    def test_sub_rejects_positional_and_keyword_units(self) -> None:
        ...
        with pytest.raises(
            ...
            span.sub(other, hours=2)  # type: ignore[call-overload]  # ty: ignore[invalid-argument-type]
