...
def test_change_an_instant_from_one_time_zone_to_another() -> None:
    ...
    assert zdt2.to_string() == "1918-11-11T06:00:00-05:00[America/New_York]"
...
def test_add_duration_to_a_zoned_datetime() -> None:
    ...
    zdt2 = zdt1.add(span)
    assert zdt2.to_string() == "2023-12-31T18:30:00-05:00[America/New_York]"


def test_dealing_with_ambiguity() -> None:
    zdt = ry.date(2024, 3, 10).at(2, 30, 0, 0).in_tz("America/New_York")
    assert zdt.to_string() == "2024-03-10T03:30:00-04:00[America/New_York]"
    zdt = ry.date(2024, 11, 3).at(1, 30, 0, 0).in_tz("America/New_York")
    assert zdt.to_string() == "2024-11-03T01:30:00-04:00[America/New_York]"
...
def test_rounding_a_zoned_datetime() -> None:
    ...
    assert nearest_minute.to_string() == "2024-07-06T17:44:00-04:00[America/New_York]"
