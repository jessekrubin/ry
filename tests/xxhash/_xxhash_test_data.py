...
Could be read with something like:
```python
from os import path

PWD = path.dirname(path.abspath(__file__))
TEST_DATA_FILE_PATH = path.join(PWD, "_xxhash_test_data.py")
...
XX64_TEST_DATA = [
    ...
    (
        b"fooba\x00",
        (0xA7970DD537275FCF, 0x8A5AF2F6D3A7B945, 0x7DED358A2484056F),
    ),
    (
        b"foobar\x00",
        (0xCEBFEDFBBA73DE25, 0x5F94E39BC583A196, 0xF414F96920020004),
    ),
    ...
    (
        b"chongo wa",
        (0x576FA1AB050E8198, 0x75D7C67B8B1A3BE3, 0x93B1A3BAA4813892),
    ),
    (
        b"chongo was",
        (0xA2EA9B100BF98674, 0x4FB3CD95B2F8FFB9, 0x79EB9C3B24598AE5),
    ),
    (
        b"chongo was ",
        (0xA21B76BC69CBCFD6, 0xFCDE751D17DF3EE2, 0xF7967B64ACAFB9E),
    ),
    (
        b"chongo was h",
        (0xB49C08239E537C63, 0x90C6CBFF9F71B37D, 0x334F42128BE1047B),
    ),
    (
        b"chongo was he",
        (0xB3FDC88FD2ECCA05, 0x7CC36A3C1355EADC, 0xB6F8C6D157029C42),
    ),
    (
        b"chongo was her",
        (0x9F26F81FDF1BFF1C, 0x616B0CA5ACC3A7, 0x446442DD0B5540DA),
    ),
    (
        b"chongo was here",
        (0x510928C48F0550, 0x43D3D73854846723, 0x98537C55D1FC5121),
    ),
    (
        b"chongo was here!",
        (0x8F2CC5680771118C, 0x70D9177A89EA5499, 0x3AAE6080D99ED79F),
    ),
    (
        b"chongo was here!\n",
    ...
    (
        b"chongo\x00",
        (0x5EF8DC96839C724C, 0x4628057F4CF4EBFF, 0x66CF873E8747B880),
    ),
    (
        b"chongo \x00",
        (0x49477446E8E4F3CA, 0xA829FF4BC2570858, 0x5243BDE69785B9D7),
    ),
    (
        b"chongo w\x00",
        (0xFF5282BD6BFCC7B5, 0x97E67D0AE64C713B, 0x33D4316E5C83D196),
    ),
    (
        b"chongo wa\x00",
        (0xF872C4370AE296EA, 0xDCD98160CDA1E845, 0x268D7D998347C5FD),
    ),
    (
        b"chongo was\x00",
        (0xDBE5DF26F7BED003, 0xDBCBF2528437E385, 0x4F7A55B1749CB24F),
    ),
    (
        b"chongo was \x00",
        (0xEC517C50D7B1C1BD, 0x3DC202BD8D5941E2, 0xEB73E876D718BFA),
    ),
    (
        b"chongo was h\x00",
        (0x6DA5E280F75FB3DD, 0xD1D64D19DB715318, 0x4A33D3DF17A92049),
    ),
    (
        b"chongo was he\x00",
    ...
    (
        ...
        (0xF2BE50AD60A4D06E, 0x2B81060B4952212, 0xD36B7722BCE7B04),
    ),
    (
    ...
    (
        b"curds and",
        (0xA526D268C34C54CA, 0x66F52A1D2C4FEF89, 0xE9B9868119AFA6D7),
    ),
    (
        b"curds and ",
        (0xDD98D1A296DC15BE, 0x29527A469EEB06D9, 0x1FA7F9DBA772E168),
    ),
    (
        b"curds and w",
        (0x9657871083A50DAD, 0xD1FD777D8DA33221, 0xBBAF209E1B4C4F6),
    ),
    (
        b"curds and wh",
        (0x65703B9EC15B1B0B, 0xA01E669A433A2EF7, 0x5CA99D4AE3EFC14A),
    ),
    (
        b"curds and whe",
        (0xC80155AEAE33FAB3, 0x2A3B39734CB04F57, 0x8CEAB7B2A565B2A7),
    ),
    (
        b"curds and whey",
        (0x28868F88194B0791, 0xC68FA8180C496B4B, 0x6D590B3CD17D4176),
    ),
    (
        b"curds and whey\n",
    ...
    (
        b"curds\x00",
        (0xD924B907E5E4B82E, 0x58F2900FC1D169E0, 0x324530BFD31235DA),
    ),
    (
        b"curds \x00",
        (0xA06D7E5791EE58F5, 0x7CFCF649AD47594F, 0x455FC6465333CCB1),
    ),
    (
        b"curds a\x00",
        (0x3F2E5D7432EB5EB2, 0xF62D0DA57E3B5722, 0xA044206065EBCFE3),
    ),
    (
        b"curds an\x00",
        (0x3BF4FBCDB7D8AAFE, 0x7234843F7793AD1A, 0x46C90C6256DDC196),
    ),
    (
        b"curds and\x00",
        (0xC84BE4E1185CE184, 0x80DB924599A14677, 0x85D631EF9BFBA54F),
    ),
    (
        b"curds and \x00",
        (0x45210644FD120EFA, 0x568140F1A973B76F, 0x6C383E8FDB42415B),
    ),
    (
        b"curds and w\x00",
        (0xC4BD7AF71FDD0BEB, 0xA1406D6745C46004, 0x678BE83EBB260B1),
    ),
    (
        b"curds and wh\x00",
        (0x7066228F42F6D8F6, 0x8A7197DEF1CE3E2D, 0x5473C146F4923221),
    ),
    (
        b"curds and whe\x00",
    ...
    (
        b"hello\x00",
        (0x54ADE4242FEC4E26, 0xE3AD5D764FCEDBCF, 0xBC3902259045F435),
    ),
    (
        b"\xff\x00\x00\x01",
        (0x4ED08571477FF888, 0x57132CC94DAA9795, 0x1834E09F80D7F591),
    ),
    (
        b"\x01\x00\x00\xff",
        (0xC3F46FECCCBFBC6E, 0x4F85DD41C428C8F0, 0x18D6A316E815DAEE),
    ),
    (
        b"\xff\x00\x00\x02",
        (0x400BE77598EA174C, 0x50AB188D347E03EA, 0x62BEDBEFED9E17D),
    ),
    (
        b"\x02\x00\x00\xff",
        (0xA138B6138C8F6E5F, 0xF3C61127CCBF28E9, 0xA193DDCC8314A162),
    ),
    (
        b"\xff\x00\x00\x03",
        (0xF483F36B2A2582D7, 0x83F7C856215A051F, 0xDED6FEE362CDB721),
    ),
    (
        b"\x03\x00\x00\xff",
        (0xC069C80CBE5C88FB, 0x58BF3630815CD2ED, 0x2CD3082EA38044F),
    ),
    (
        b"\xff\x00\x00\x04",
        (0xA0C21B98AEED43CA, 0x7EFCD1A50C4EC4C7, 0xAA73824F924AB5C9),
    ),
    (
        b"\x04\x00\x00\xff",
        (0xE8265E3ED97AB2BA, 0xE59DA93CC29890AB, 0x576063A273F1F22B),
    ),
    ...
    (
        b"127.0.0.1",
        (0xC08B1587DF65B7A7, 0x48E37914BFE6FD4C, 0x8487115FE6B4D594),
    ),
    (
        b"127.0.0.1\x00",
        (0xF7AFE10FDF087BE3, 0xBC90339E2B0F6706, 0x326DBDA65B2B81FE),
    ),
    (
        b"127.0.0.2",
        (0xDA3057A00712C3B3, 0x502796520DFE99B7, 0x1BB672E59E180781),
    ),
    (
        b"127.0.0.2\x00",
        (0xCB4C15DBC99F208D, 0xF52E4DDBF33EDA7C, 0xFDAAF67FBBB057C9),
    ),
    (
        b"127.0.0.3",
        (0x95499392E61F7580, 0xA2DAEBC0B33A88BD, 0x673E717762476C76),
    ),
    (
        b"127.0.0.3\x00",
        (0xC01F9FA6A89A373E, 0xE43326FDCC0F930A, 0xB391B39C12126801),
    ),
    (
        b"64.81.78.68",
        (0xC713EC358F4B3891, 0xE0162A5D402241C9, 0xC95B122E43AB73E4),
    ),
    (
        b"64.81.78.68\x00",
        (0x49D1D7D4CC2538CE, 0x4BE7212B025F164C, 0x2E2082A3EC63A80A),
    ),
    (
        b"64.81.78.74",
        (0x3E6DC31B80A5A450, 0xB3A38AC2256659E0, 0xC5737196DF5D088B),
    ),
    (
        b"64.81.78.74\x00",
        (0x12AA7038043C8C83, 0xFE8150FD5CA75EA2, 0x9BF35885A4137121),
    ),
    (
        b"64.81.78.84",
        (0xC915802FF0C2EDB2, 0x33A55B8A7B1AB343, 0x10CC40BE25CC791B),
    ),
    (
        b"64.81.78.84\x00",
        (0x7FF782570D573B3C, 0x5F202BA87BFC0646, 0xFDB5B12DEC812F3A),
    ),
    (b"feedface", (0x94B5CE750F90998D, 0xBFF73B35D3069096, 0xA8CA53DFFF2AC69F)),
    (
        b"feedface\x00",
        (0x10B342529899B0F7, 0xBDD0C7CD4D89A9F0, 0xC42DF8F061AFED1B),
    ),
    (
        b"feedfacedaffdeed",
        (0x5A7AFA18DDC6A064, 0x38612467FE905A5A, 0xE76006AB78C6D93D),
    ),
    (
    ...
    (
        b"feedfacedeadbeef",
        (0x3701A5ACFF61B7F3, 0x33A1A84FCCC1BB78, 0xDA3C2C457EB92296),
    ),
    (
...
XX3_64_TEST_DATA = [
    ...
    (
        b"foobar\x00",
        (0x42C9FE3205FC4571, 0x77A516A739FE1D61, 0xC2C526E64E84C8AA),
    ),
    ...
    (
        b"chongo wa",
        (0x735A9211B14A31C4, 0x66DD47B47342632F, 0xE0EF08515B66BFE2),
    ),
    (
        b"chongo was",
        (0x8FCB143B13BC7570, 0xB4E4C84426A331B3, 0x82C288223D998230),
    ),
    (
        b"chongo was ",
        (0xB1D2B1DCB84B1AB8, 0x242D5C3315D4DEF9, 0xB1AEA65DBA0E47FD),
    ),
    (
        b"chongo was h",
        (0xB971B96DC49201C2, 0xA0A61D7C6F5C1BA4, 0xECE1A8759626BB0F),
    ),
    (
        b"chongo was he",
        (0x6C53AEB7DFDFE950, 0xD217308DD502CDEA, 0x8968BCB8B95767F8),
    ),
    (
        b"chongo was her",
        (0x38ED4FF48C0A80, 0x37429EC880648025, 0x8ACDC31871843398),
    ),
    (
        b"chongo was here",
        (0x203C27F0C59EF2B6, 0x603131813E8E8C50, 0xE396EF58251E0A25),
    ),
    (
        b"chongo was here!",
        (0xCFB35945B5996461, 0x8244E966B003C141, 0x46CDF4C519BC4C07),
    ),
    (
        b"chongo was here!\n",
    ...
    (
        b"chong\x00",
        (0x9A20CF60E343F260, 0x4C39C11F6EA6FD74, 0xBBD6F972F8351A84),
    ),
    (
        b"chongo\x00",
        (0xA6002994504B8B52, 0x8503F1CB89C8B7B8, 0xC087A97D75CF7DC0),
    ),
    (
        b"chongo \x00",
        (0x75A8D41513B71127, 0x45B17AFE5DE609AC, 0xB57285163199FDE5),
    ),
    (
        b"chongo w\x00",
        (0xFEF0A9E3FFA1EBE4, 0xE4633342D3F681D7, 0x3E1561A51DE18A78),
    ),
    (
        b"chongo wa\x00",
        (0x2DFD8E507534EC1F, 0x64DB06D71498B68D, 0xFA27E5967FB504EF),
    ),
    (
        b"chongo was\x00",
        (0x842796EA832A141E, 0xB4C9F16098B68401, 0x18EF6889170EC308),
    ),
    (
        b"chongo was \x00",
        (0x1F389BD6914C8330, 0x6A05846F48A4915B, 0x89060736BD382781),
    ),
    (
        b"chongo was h\x00",
        (0x51EA8BFE0C2C633B, 0x4EC1703A8444A752, 0xB7FE4C4D7ACC755D),
    ),
    (
        b"chongo was he\x00",
    ...
    (
        b"curds and",
        (0xF424A63C7B617897, 0x90CCD302E3E4694D, 0xD30F3F14B9E7A715),
    ),
    (
        b"curds and ",
        (0xE0C5C7EE567C99DF, 0x2BA95AEA635E71CF, 0x7359F41BF5403DFA),
    ),
    (
        b"curds and w",
        (0xD6E080E1AAEFE32B, 0xDDA5F6DC3AFB0706, 0x6314C4AB8F1D6FC3),
    ),
    (
        b"curds and wh",
        (0x8C4BE06520FEE011, 0x3CCA77D4AEB49424, 0x67135F36E05A4012),
    ),
    (
        b"curds and whe",
        (0xAE6A78FC37D04A4E, 0xDA858092257A9F21, 0x5CD6B552D6EEF0DA),
    ),
    (
        b"curds and whey",
        (0xA0F3E1B5D011565E, 0x8B44C943BFCB6338, 0x517571686BC8F87D),
    ),
    (
        b"curds and whey\n",
    ...
    (
        b"curds\x00",
        (0x6DB0E8041F3E6641, 0x127E0D0365CA78A9, 0x231CADBDAE8F9CC7),
    ),
    (
        b"curds \x00",
        (0xBCF7B46C78676148, 0x4F67A9015DAB8280, 0x501FDDFA27984EA7),
    ),
    (
        b"curds a\x00",
        (0x7D18F50DAC985B90, 0x110A9CE4198D9650, 0x7EDF20CA48A0A51B),
    ),
    (
        b"curds an\x00",
        (0x4D6F668C4A8D31FE, 0x6DAA8E107DDE0BF6, 0xF9DC73D963730F87),
    ),
    (
        b"curds and\x00",
        (0x82D18DCF64564AB5, 0xFA3D0508A49FF0B9, 0xB2D7F57E967B2550),
    ),
    (
        b"curds and \x00",
        (0x46C6673D667F77E2, 0x61A7B586A5B92134, 0x1EBF86756A41F988),
    ),
    (
        b"curds and w\x00",
        (0xA683562977CF0DA4, 0x68247D95BA25D525, 0x24717309606FC6F7),
    ),
    (
        b"curds and wh\x00",
        (0x625207A3C37E5856, 0x968D1B68281C11F0, 0x55B96409E95D9C02),
    ),
    (
        b"curds and whe\x00",
        (0x6510AD9354F51553, 0x6DA78CEFE750AC22, 0x4E7A4E667E9756B),
    ),
    (
        b"curds and whey\x00",
    ...
    (
        b"hello\x00",
        (0xC5AB198C53EB7646, 0x3DBD18E1539277B7, 0xB8DAA345C4A2BBC2),
    ),
    (
        b"\xff\x00\x00\x01",
        (0x64C5DE8AFCCBC45B, 0xBF2DBA0183F9E63A, 0x8EB57A872BEAB06E),
    ),
    (
        b"\x01\x00\x00\xff",
        (0xF588AB92DAC187AE, 0x62B7387ABCB0B83E, 0x7551FC434A157D23),
    ),
    (
        b"\xff\x00\x00\x02",
        (0x4EF45403CACF602D, 0xEEDB6121C525BC15, 0xD4BA6B6F8585BA4),
    ),
    (
        b"\x02\x00\x00\xff",
        (0x212919C195260F4A, 0x5ACE20C0E02E51CC, 0xBD70FC11B7F85446),
    ),
    (
        b"\xff\x00\x00\x03",
        (0xA449F01DA961F1AB, 0xC16315059D1AC01, 0xFB43830D4C731F56),
    ),
    (
        b"\x03\x00\x00\xff",
        (0x4E3BD19B5143C383, 0xF434CD22ABC3CC11, 0x4998138AA96A1EB9),
    ),
    (
        b"\xff\x00\x00\x04",
        (0x2AF5CD1BC6CA9A5F, 0x80727ACE7CF67D39, 0x6BCC2E1FF60CD13A),
    ),
    (
        b"\x04\x00\x00\xff",
        (0x2A2D9D2F2642152F, 0x2138F857F8EFA490, 0x16CAF144318FEA9A),
    ),
    ...
    (
        b"127.0.0.1",
        (0x9A071D171774168C, 0x6D2D8FA2DF24F5AC, 0xD27E1A38D6BC6448),
    ),
    (
        b"127.0.0.1\x00",
        (0x31FC5C6A38C3D507, 0x6C7817ED89CA1B17, 0x9D6E60C0271BEA6B),
    ),
    (b"127.0.0.2", (0xE60C80E6B5EDD112, 0xC301F13E317E073, 0xE8FD3B1B832E62A1)),
    (
        b"127.0.0.2\x00",
        (0x2262D112AE2AB1CF, 0x824A3F8CCE87816B, 0x86A95B46D34089C9),
    ),
    (
        b"127.0.0.3",
        (0x96DC86343069CCC2, 0x732FEF6DB3A4FAE8, 0xEFDA680CADD3C6A7),
    ),
    (
        b"127.0.0.3\x00",
        (0x1C891D48BF0292CB, 0xCB43F9C2CF91898D, 0x57D3575D46028F0B),
    ),
    (
        b"64.81.78.68",
        (0xFB78FB4DDEF2E69A, 0x90AAE4D78D834200, 0xA6EAE0519EF9A3FF),
    ),
    (
        b"64.81.78.68\x00",
        (0xCDE79DA2E087B43B, 0x1F350134E946A5CA, 0xA673699D9FB13861),
    ),
    (
        b"64.81.78.74",
        (0x93CCF563CAA4B277, 0xC7AEAB5BF7F7F7EC, 0xC7343644A95F9D71),
    ),
    (
        b"64.81.78.74\x00",
        (0x50CD907F7733FC45, 0x6CF4F091254DB4DB, 0xED3187780A6A6920),
    ),
    (
        b"64.81.78.84",
        (0x195B95A1B2AF0874, 0x81FBE926B6273C3, 0xC4FF94F238902AAC),
    ),
    (
        b"64.81.78.84\x00",
        (0xAA4FDFDA2085929D, 0xD86D37BFF33601E6, 0x64B66D56B9637BED),
    ),
    (b"feedface", (0xEDF978081D2BFD26, 0x85C2B9DE12AD51BC, 0xF315DD9DC7208984)),
    (
        b"feedface\x00",
        (0xF045662086B9F02C, 0x7948C5853B3B2852, 0xE465F2577C86B80B),
    ),
    (
        b"feedfacedaffdeed",
        (0x89D1259B72D3D007, 0xC8339C2AB46DB802, 0x3911931F71DD8CF5),
    ),
    (
        b"feedfacedaffdeed\x00",
    ...
    (
        b"feedfacedeadbeef",
        (0x1A253CC7EC1954C5, 0xFD4808B6FC3CDC04, 0x52E783C9BBCCB998),
    ),
    (
        b"feedfacedeadbeef\x00",
